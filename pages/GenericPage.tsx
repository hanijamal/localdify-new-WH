...
const pageContents: { [key: string]: any } = {
  'privacy-policy': {
    ...
    content: {
      ...
      "ar": "<div dir=\"rtl\" style=\"text-align: right; font-family: 'IBM Plex Sans Arabic', sans-serif;\"><h1>سياسة الخصوصية</h1><p>مرحبًا بك في localDify ('نحن' أو 'خاصتنا'). نحن ملتزمون بحماية خصوصيتك. تشرح سياسة الخصوصية هذه كيف نجمع معلوماتك ونستخدمها ونكشف عنها ونحميها عند استخدام خدمتنا.</p>... (محتوى مترجم) ...</div>"
    }
  },
  'terms-of-service': {
    ...
    content: {
      ...
      "ar": "<div dir=\"rtl\" style=\"text-align: right; font-family: 'IBM Plex Sans Arabic', sans-serif;\"><h1>شروط الخدمة</h1><p>يرجى قراءة شروط الخدمة هذه ('الشروط') بعناية قبل استخدام خدمة localDify ('الخدمة') التي نديرها.</p>... (محتوى مترجم) ...</div>"
    }
  }
};
